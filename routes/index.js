	...
	constructor(registry) {
		...
		this.router.get('/login', (req, res) => {
			if (this.registry.isActiveSession(req.cookies.sessionId)) {
				...
				res.redirect('https://discordapp.com/oauth2/authorize?response_type=code&redirect_uri=https%3A%2F%2Fwaifubot.moe/api/auth&scope=identify guilds&client_id=259932651417370624');
			}
		});
